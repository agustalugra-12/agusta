        ...
        <DialogContent>
          ...
          {bookingDetail && !rescheduleMode && (
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center gap-1.5">
                <span className="text-slate-500">Kode PMS:</span>
                <code className="text-xs font-mono bg-slate-100 border border-slate-200 rounded px-1.5 py-0.5" data-testid="booking-detail-kode">{bookingDetail.kode}</code>
                <button
                  type="button"
                  title="Salin kode booking"
                  onClick={() => { navigator.clipboard?.writeText(bookingDetail.kode); toast.success("Kode booking disalin"); }}
